...
▸ 사용 예
    # FORWARD 모드로 전환
    ros2 service call /controller_mode_switcher/switch_mode \\
    ...
    ros2 topic pub /arm/xarm7_forward_controller/commands \\
        std_msgs/msg/Float64MultiArray '{data: [0.0, 0.3, 0.0, 0.3, -3.14, 0.0, 0.0]}' --once

    # FORWARD 모드에서 lift 명령 예시 (단위: m)
    ros2 topic pub /body/lift_forward_controller/commands \\
